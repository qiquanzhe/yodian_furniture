				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 wow fadeInLeft">
							...
							<div id="success"></div>
							<form onsubmit="return toVaild()" action="loginService.jsp" method="post" class="b-form">
								<div class="form-group">
									<div class="row">
										<div class="col-sm-12">
											<input type="text" class="form-control" id="loginname" name="loginname" placeholder="请输入您的邮箱/手机号/昵称 *">
                                            <input  type="hidden" id="inputtype" name="inputtype" />
                                            <span id="logintip" style=" font-size: 10px;color: red"> .</span>
										</div>
										<div class="col-sm-12">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" name="validcode" id="validcode" placeholder="验证码 *">
										...
										<div class="col-sm-12">
											...
											<p>
												<br />
												<span style="margin-left: 79%;line-height: 30px;">没有账号？<a href="register.jsp">注册</a></span><br />
											</p>
										</div>
									</div>
								</div>
						...
						<div class="d1">
                                <a href="#"><img style="float:right"  src="media/offers/left.png" alt="/"></a>
                                </div>
					</div>
				</div>
				<div class="b-hr-mod">
...
<script src="js/loginVaild.js"></script>
	</body>
</html>

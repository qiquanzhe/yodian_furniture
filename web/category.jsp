					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
							<div class="lb-content lb-content-accordion">
								<div id="accordion1" class="accordion-l-box wow fadeInUp enable-accordion" data-active="0" data-collapsible="true" data-height-style="content">
								...
								<div id="accordion2" class="accordion-l-box wow fadeInUp enable-accordion" data-active="false" data-collapsible="true" data-height-style="content">
									<h3 class="accordion-header-mod">
						...
						<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
							...
							<div class="b-grid">
								<div class="row">
                                    <%
                                        List<furnitureUnit> list = (new FDBoperator()).searchFurnitureByType("沙发");
                                        if(list.size() == 0)
                                            ...
                                            for(int i = 0;i < list.size();i++)
                                            {
                                                if(i < 12){
                                                    ...
                                                    out.print("<div class=\"col-lg-4 col-md-4 col-sm-4 col-xs-6\">" +
                                                            ...
                                                            "<img style=\"width:260px;height:246px\" src=\""+request.getContextPath()+"/upload/"+(new IMDBoperator()).searchImageById(list.get(0).getFid()).get(0).getFimg() +"\" class=\"img-responsive center-block\" alt=\"Item\">" +
									...
									<script>
                                        ...
                                        function addtowish(param){
                                            window.location.href="addToWish.jsp?fid="+param;
										}
                                    </script>
								</div>
							</div>

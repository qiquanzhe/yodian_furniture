...
<div class="page-container">
	<form action="editfurniture.jsp" method="post" onsubmit="return preSubmit()" class="form form-horizontal" id="form-article-add" >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>编  号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=fid%>" id="fno" name="fno" readonly="readonly" unselectable="on">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="ftype" class="select" disabled>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="fprice" id="fprice" placeholder="" value="" class="input-text" style="width:98%">
				元
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<span style="color: red;font-size: 10px">
					<%
						String add = (String)session.getAttribute("edit");
